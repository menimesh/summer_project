...
<head>
    ...
    <link rel="icon" href="#">
    <title>EasternEatsExpress</title>
...
<body class="home">
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/logo1.png" alt="" width="14%"> </a>
    ...
    <section class="hero bg-image" data-image-src="images/img/logo2.jpg">
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
               <u> <h2>Flavor of the Month</h2></u>
                <p class="lead">Top Tastes to Your Door</p>
            </div>
            <div class="row">
                <?php 					
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <p>We have added different menu from different resturant.</p>
                            </div>
                        </div>
                    </div> 
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <h3>Choose a dish</h3>
                            <p>We have contain different item in menu.</p>
                        </div>
                    </div>
